...
<!--top-->
<br />
<form name="pay" method="post" action="bc_send.jsp">
		...
		<table width="100%" border="0" cellspacing="1">
		 ...
		 <tr>
		  ...
		  <tr>
		    ...
		    <td class="bg_yellow2" 	align="left">&nbsp;&nbsp;<input type="text" name="page_notify_url"   value = 'http://www-1.fuiou.com:8888/pay_test/result.jsp'/></td>
		  </tr>
		  
		  <tr>
		    <td width="200" class="bg_gray" align="right" >支付成功后台通知URL：&nbsp;&nbsp;</td>
		    <td class="bg_yellow2" 	align="left">&nbsp;&nbsp;<input type="text" name="back_notify_url"  value = 'http://www-1.fuiou.com:8888/pay_test/result.jsp'/></td>
		  </tr>
