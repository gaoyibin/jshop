...
<html>
	...
	<%
        ...
        //付款金额，必填
        String total_fee = new String(String.valueOf(payInfo.getWIDprice()+payInfo.getLogistics_fee()).getBytes("ISO-8859-1"),"UTF-8");
		...
		sParaTemp.put("notify_url", SystemManager.getInstance().getSystemSetting().getWww()+"/paygate/alipay/"+AlipayConfig.notify_url);
		sParaTemp.put("return_url", SystemManager.getInstance().getSystemSetting().getWww()+"paygate/alipay/"+AlipayConfig.return_url);
