...
//			log.info(code.toString());
        ...
        manageExpressMap.put("shunfeng", "&#x987A;&#x98CE;&#x5FEB;&#x9012;");//顺风
        manageExpressMap.put("ems", "EMS");
        manageExpressMap.put("shentong", "&#x7533;&#x901A;E&#x7269;&#x6D41;");//申通E物流
        manageExpressMap.put("yuantong", "&#x5706;&#x901A;&#x901F;&#x9012;");//圆通速递
        manageExpressMap.put("zhongtong", "&#x4E2D;&#x901A;&#x901F;&#x9012;");//中通速递
        manageExpressMap.put("zhaijisong", "&#x5B85;&#x6025;&#x9001;");//宅急送
        manageExpressMap.put("yunda", "&#x97F5;&#x8FBE;&#x5FEB;&#x8FD0;");//韵达快运
        manageExpressMap.put("tiantian", "&#x5929;&#x5929;&#x5FEB;&#x9012;");//天天快递
        manageExpressMap.put("lianbangkuaidi", "&#x8054;&#x90A6;&#x5FEB;&#x9012;");//联邦快递
        manageExpressMap.put("huitongkuaidi", "&#x6C47;&#x901A;&#x5FEB;&#x8FD0;");//汇通快运
	}
...
//        this.articleCatalogJsonStr = articleCatalogJsonStr;
    ...
    public Map<String,String> getPays() {
        return getCacheObject("pays");
    }

    public void setPays(Map<String,String> pays) {
        putCacheObject("pays", (Serializable)(pays));
    }
